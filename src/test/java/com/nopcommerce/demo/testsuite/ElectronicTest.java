...
public class ElectronicTest extends BaseTest {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        electronicsPage.enterFirstname("Shubh");
        electronicsPage.enterLastname("Bhai");
        electronicsPage.enterEmail1("shubhai@gmail.com");
        electronicsPage.enterPassword("test123");
        electronicsPage.enterConfirmPassword("test123");
        Thread.sleep(500);
        ...
        electronicsPage.enterAddress1("10 Downing St");
        electronicsPage.enterZipPostalCode("OV16 5TX");
        electronicsPage.enterPhoneNumber("01753448987");
