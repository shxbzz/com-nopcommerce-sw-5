...
public class ComputerPageTest extends BaseTest {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() {
        ...
        computerPage.enterFirstName("Shubh");
        computerPage.enterLastName("Bhai");
        computerPage.enterEmailId("shubhai@gmail.com");
        computerPage.selectCounty("United Kingdom");
        computerPage.enterCityField("London");
        computerPage.enterAddress1("10 Downing St");
        computerPage.enterzipCode("OV16 5TX");
        computerPage.enterPhoneNumber("01753448987");
        ...
        computerPage.selectCardHolderName("MR S D Bhai");
